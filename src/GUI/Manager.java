...
public class Manager extends JFrame{
	...
	private final int leftPush = 100;
	private final int rightPush = -10;
	private final int labelPush = 10;
	private final int leftPushRightObject = 20;
	...
	public Manager() {
		...
		gbc_lblTicker.insets = new Insets(0, leftPush, 5, 5);
		...
		JLabel lblticker = new JLabel("#TICKER");
		GridBagConstraints gbc_lblticker = new GridBagConstraints();
		gbc_lblticker.insets = new Insets(0, labelPush, 5, 5);
		...
		gbc_lblToday.insets = new Insets(0, leftPush-30, 5, 5);
		...
		gbc_lblPrice.insets = new Insets(0, leftPush, 5, 5);
		...
		JLabel lblprice = new JLabel("#PRICE");
		GridBagConstraints gbc_lblprice = new GridBagConstraints();
		gbc_lblprice.insets = new Insets(0, labelPush, 5, 5);
		...
		gbc_lblDailyChnage.insets = new Insets(0, leftPushRightObject, 5, 5);
		...
		gbc_lbldh.insets = new Insets(0, rightPush, 5, 0);
		gbc_lbldh.gridx = 8;
		gbc_lbldh.gridy = 1;
		...
		gbc_lblMarketCap.insets = new Insets(0, leftPush, 5, 5);
		...
		gbc_lblmc.insets = new Insets(0, labelPush, 5, 5);
		gbc_lblmc.gridx = 3;
		gbc_lblmc.gridy = 2;
		...
		gbc_lblNewLabel_1.insets = new Insets(0, leftPushRightObject, 5, 5);
		...
		gbc_lbldl.insets = new Insets(0, rightPush, 5, 0);
		gbc_lbldl.gridx = 8;
		gbc_lbldl.gridy = 2;
		...
		gbc_lblNewLabel.insets = new Insets(0, leftPush, 0, 5);
		...
		gbc_lblpe.insets = new Insets(0, labelPush, 0, 5);
		gbc_lblpe.gridx = 3;
		gbc_lblpe.gridy = 3;
		...
		gbc_lblVolume.insets = new Insets(0, leftPushRightObject, 0, 5);
		...
		gbc_lblvol.insets = new Insets(0, rightPush, 0, 5);
		gbc_lblvol.gridx = 8;
		gbc_lblvol.gridy = 3;
